...
class Rsync(IWrapper):
    ...
    def set_args(self, log, args_handler):
        args_handler.add_app_args(log, Keys.SOURCE, '')
        return args_handler
    ...
    def prepare_run(self, info, log):
        ...
        @precondition: 'info' object has to contain the following key [SOURCE,DESTINATION]
        """

        #get path to copy
        path = info[Keys.SOURCE]
    ...
    def validate_run(self, info, log, run_code, out_stream, err_stream):
        ...
        if run_code == 0:
            ...
            copyoutput = []
            outdir = info[Keys.SOURCE].split()[1] + '/'
            ...
            info[Keys.DESTINATION] = copyoutput
        else:
            if run_code == 12:
