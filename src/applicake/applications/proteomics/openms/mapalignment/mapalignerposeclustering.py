...
class MapAlignerPoseClustering(OpenMs):
    """
    classdocs
    """
    ...
    def _get_prefix(self,info,log):
        if not info.has_key(self.PREFIX):
            info[self.PREFIX] = 'MapAlignerPoseClustering'
    ...
    def get_template_handler(self):
        ...
        See interface
        """
        return MapAlignerPoseClusteringTemplate()
    ...
    def set_args(self,log,args_handler):
        ...
        See interface
        """
        args_handler = super(MapAlignerPoseClustering, self).set_args(log,args_handler)
        #args_handler.add_app_args(log, '', '')
        return args_handler


class MapAlignerPoseClusteringTemplate(BasicTemplateHandler):
    """
    Template handler for MapAlignerPoseClustering.
    """
