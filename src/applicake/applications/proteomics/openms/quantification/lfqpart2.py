...
class LFQpart2(IWrapper):
    ...
    def prepare_run(self,info,log):
        ...
        info['PROTCSV'] = os.path.join(wd,'TOPPAS_out/010-ProteinQuantifier/out_tmp19.unknown')
        info['PEPCSV'] = os.path.join(wd,'TOPPAS_out/011-ProteinQuantifier/out_tmp20.unknown')
...
<PARAMETERS version="1.3" xsi:noNamespaceSchemaLocation="http://open-ms.sourceforge.net/schemas/Param_1_3.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <NODE name="vertices" description="">
    ...
    <NODE name="3" description="">
      ...
      <NODE name="parameters" description="">
        <ITEMLIST name="in" type="string" description="Input files separated by blanks (all must have the same file type)" tags="input file,required">
        </ITEMLIST>
        <ITEMLIST name="out" type="string" description="Output files separated by blanks" tags="output file">
        </ITEMLIST>
        <ITEMLIST name="trafo_out" type="string" description="Transformation output files separated by blanks" tags="output file">
        </ITEMLIST>
        ...
        <NODE name="reference" description="Options to define a reference file">
          <ITEM name="file" value="" type="string" description="File to use as reference" tags="input file" />
    ...
    <NODE name="4" description="">
      ...
      <ITEM name="y_pos" value="-60" type="float" description="" />
      <NODE name="parameters" description="">
        <ITEMLIST name="in" type="string" description="input files separated by blanks" tags="input file,required">
        </ITEMLIST>
    ...
    <NODE name="8" description="">
      ...
      <NODE name="parameters" description="">
        ...
        <ITEM name="protxml" value="" type="string" description="ProteinProphet results (protXML converted to idXML) for the identification runs that were used to annotate the input.#br#Information about indistinguishable proteins will be used for protein quantification." tags="input file" />
  ...
  <NODE name="edges" description="">
    ...
    <NODE name="2" description="">
      <NODE name="source/target" description="">
        <ITEM name="" value="4/8" type="string" description="" />
      </NODE>
      <NODE name="source_out_param" description="">
        <ITEM name="" value="out" type="string" description="" />
      </NODE>
    ...
    <NODE name="7" description="">
      <NODE name="source/target" description="">
        <ITEM name="" value="0/7" type="string" description="" />
      </NODE>
      <NODE name="source_out_param" description="">
        <ITEM name="" value="__no_name__" type="string" description="" />
      </NODE>
