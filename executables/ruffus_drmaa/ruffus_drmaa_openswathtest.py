...
def chromextract(input_file_name, output_file_name):   
    submitter.run('run_chromextract.py', ['-i',  input_file_name,'-o', output_file_name,'--THREADS', '8'],lsf8args)
