...
THREADS = 8
MZMLGZ = /cluster/apps/openms/openswath/OpenSWATH/data/testdata/SRMMapping_files.tar.gz
TRAML = /cluster/apps/openms/openswath/OpenSWATH/data/testdata/MRMDecoyGenerator_input.TraML
