...
class AnnotProtxmlFromUpdatedCsv(BasicApp):
    def add_args(self):
        return [
            ...
            Argument('PROTCSV', 'Path to CSV input file containing prot abundances'),
            Argument('PEPCSV', 'Path to CSV input file containing peptide abundances'),
            Argument('DELIM', 'Field delimiter used in CSV input (optional)', default=','),
            Argument('INDENT', 'Additional indentation for abundance entries in the protXML output (optional)',
                     default='   ')
        ]
...
if __name__ == "__main__":
    AnnotProtxmlFromUpdatedCsv.main()