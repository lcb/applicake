PrecursorMzTolerance= $PRECMASSERR
PrecursorMzToleranceUnits = $PRECMASSUNIT
FragmentMzTolerance = $FRAGMASSERR
FragmentMzToleranceUnits = $FRAGMASSUNIT
...
NumMaxMissedCleavages = $MISSEDCLEAVAGE
